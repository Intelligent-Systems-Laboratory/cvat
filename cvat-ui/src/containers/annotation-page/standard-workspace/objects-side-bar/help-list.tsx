...
import HelpListComponent from 'components/annotation-page/standard-workspace/objects-side-bar/help-list';
import {
...
class HelpListContainer extends React.PureComponent<Props, State> {
